...
public class ProductAPI {
	...
	@PostMapping(value= "/prodMS/addSubscription")
	public ResponseEntity<String> addSubscription(@RequestBody SubscribedProductDTO sProduct){
		try {
			String msg = productService.addProductSubscription(sProduct);
